...
HD_PWD='C:/Users/Rickard Bemm/OneDrive/Dokument/Skola/Universitet/D0011E, Digitalteknik/Uppgifter/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCDcheck2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCDcheck2.tcl
