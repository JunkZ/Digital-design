...
HD_PWD='C:/Users/Rickard Bemm/OneDrive/Dokument/Skola/Universitet/D0011E, Digitalteknik/Uppgifter/lab 2/lab 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SOPcomponent.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SOPcomponent.tcl -notrace
